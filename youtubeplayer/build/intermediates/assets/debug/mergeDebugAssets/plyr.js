typeof navigator === "object" && (function (global, factory) {
  ...
  function loadSprite(url, id, playContainer) {
    if (!is.string(url)) {
      return;
    }
    const prefix = 'cache';
    ...
    const update = (container, data) => {
      ...
      playContainer.appendChild(container);
    };
  ...
  const controls = {
    ...
    updateSeekTooltip(event) {
      ...
      if (point) {
        ...
        tipElement.classList.add('plyr__tooltip--label');
      } else {
        tipElement.classList.remove('plyr__tooltip--label');
      }
    ...
    inject() {
      ...
      if (this.config.loadSprite) {
        ...
        if (icon.cors) {
          loadSprite(icon.url, 'sprite-plyr', this.elements.container);
        }
      }
  ...
  class Fullscreen {
    constructor(player) {
      ...
      on.call(this.player, this.player.elements.container, 'dblclick', event => {
        ...
        // Ignore double click on search bar.
        const searchBar = this.player.elements.container.querySelector('presto-search-bar-ui');
        if (is.element(searchBar) && searchBar.contains(event.target)) {
          return;
        }
  ...
  const vimeo = {
    ...
    ready() {
      ...
      // Commented this code to disable captions for vimeo videos due to the issue with double captions. 
      // Get captions
